...
1. **PV anomaly** — captures amplitude growth or decay (intensification)
2. **Zonal PV gradient** — rigid east–west propagation
3. **Meridional PV gradient** — rigid north–south propagation
4. **Cross-derivative of PV** — diagonal strain associated with Rossby wave breaking
